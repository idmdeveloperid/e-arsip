...
$id = $_GET["id"];
$a = query("SELECT * FROM surat_masuk WHERE id = $id")[0];
...
if(isset($_POST["ubah"])) {
	...
	if(updatesm($_POST)){
		echo "<script>
		 ...
		 window.location.href = 'detail-suratm.php?id=$id';
		</script>";
	} else {
		echo "<script>
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-3">
						<div class="">
						<a class="btn btn-secondary pull-left" href="surat-masuk.php">Kembali</a>
						<a class="btn btn-danger pull-right" href="delsm.php?id=<?= $a["id"] ;?>" onclick="return confirm('Hapus Arsip??');"><i class="fa fa-trash"></i> Hapus</a>
						</div>
					</div>
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Tanggal Diterima</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="tanggal_diterima" type="text" value="<?= $a["tanggal_diterima"] ;?>">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Asal Surat</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="asal_surat" value="<?= $a["asal_surat"] ;?>" type="text">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Ditujukan Ke</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="ditujukan" value="<?= $a["ditujukan"] ;?>" type="text">
							</div>
						</div>
						<div class="form-group row">
